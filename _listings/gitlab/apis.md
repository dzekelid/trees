...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/trees/master/_listings/gitlab/apis.md
...
- name: API title - Get Projects Repository Tree
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/trees/master/_listings/gitlab/v3projectsidrepositorytree-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/trees/master/_listings/gitlab/v3projectsidrepositorytree-get-openapi.md
- name: API title - Get Projects Repository Tree
  x-api-slug: v3projectsidrepositorytree-get
  description: Get a project repository tree
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/githlab-logo.png
